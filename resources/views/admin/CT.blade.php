      ...
      <table id="order-listing" class="table table-striped" style="width:100%;">
        ...
        <tbody>
          ...
          <tr>
              ...
              <td>
                <a href="{{URL::to('student/'.$row->id)}}" class="btn btn-outline-primary">View</a>
                <a href="{{URL::to('student/'.$row->id.'/edit')}}" class="btn btn-outline-warning">Eidt</a>
                <a href="{{URL::to('/student/delete/'.$row->id)}}" class="btn btn-outline-danger" id="delete"  type="submit">Delete</a>
              </td>
          </tr>
